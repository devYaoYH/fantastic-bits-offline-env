...
javac -d ./build java/com/codingame/agent/*.java java/com/codingame/game/Simulator.java java/com/codingame/game/GameNode.java java/com/codingame/game/WizardAction.java java/com/codingame/game/Action.java || exit 1
# Generate .jar
cd build
